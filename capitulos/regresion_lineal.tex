...
\\
\todo[inline, color=blue!20]{Discusión: ¿por qué lineal? por fácil y por optimalidad bajo supuesto de gaussianidad}
...
\\
\todo[inline, color=blue!20]{Discusión: Discutir interpretación geométrica del criterio de mínimos cuadrados  con la siguiente figura}
...
\\
\todo[inline, color=blue!20]{Discusión: Referencias, Compressed sensing, sparse feature selection}
