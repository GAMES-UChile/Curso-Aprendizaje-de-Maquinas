...
\\
\todo[inline, color=red!40]{Pendiente: ¿por qué lineal? por fácil y por optimalidad bajo supuesto de gaussianidad}
...
\\
\todo[inline, color=red!40]{Pendiente: Discutir interpretación geométrica del criterio de mínimos cuadrados  con la siguiente figura}
...
\\
\todo[inline, color=red!40]{Referencias pendiente: Compressed sensing, sparse feature selection}
