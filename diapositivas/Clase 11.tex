...
La validación cruzada es usada para seleccionar modelos, por ejemplo, un modelo polinimial de orden 5 versos orden 6, en ese sentido, se está encontrando un parámetro que es difícil encontrar mediante máxima verosimilitud. Entonces ¿es posible ocupar entonces la verosimilitud para seleccionar modelos?\\~\
