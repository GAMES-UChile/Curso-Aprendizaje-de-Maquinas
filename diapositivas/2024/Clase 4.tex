...
Es importante recalcar que la función $L(\theta)$ \textbf{no es una densidad de probabilidad}, ya que si bien $p(\{y_i\}_{i=1}^N | \theta)$ integra 1 cuando se integra con respecto a los datos $y$, no necesariamente integra 1 cuando se integra con respecto a $\theta$ (y los datos son fijos).
