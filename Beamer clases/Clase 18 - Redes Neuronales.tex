...
\begin{figure}[H]
    \centering
    \visible<1->{\includegraphics[scale=.35]{../img/kernel_cnn}}
...
\centering
\visible<3->{\includegraphics[scale=.3]{../img/RNN1.png}}
\end{figure}
...
\begin{columns}
  ...
  \begin{column}{0.5\textwidth}
    ...
    \centering
    \visible<5->{\includegraphics[scale=.2]{../img/RNN2.png}}
    \end{figure}
...
\captionsetup{font=small,labelfont=small}
\centering
\visible<3->{\includegraphics[scale=1.5]{../img/cap5_autoencoder}}
\end{figure}
...
\captionsetup{font=small,labelfont=small}
\centering
\includegraphics[scale=.7]{../img/gans.PNG}
