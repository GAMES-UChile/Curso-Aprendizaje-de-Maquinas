...
\input{preambulo}
\title{\textbf{Aprendizaje de máquinas} \\ Regularización}
...
\begin{theorem}[descomposición sesgo-varianza para MC]
	\begin{align*}
...
\begin{theorem}[descomposición sesgo-varianza para ridge regression]
	\begin{align*}
